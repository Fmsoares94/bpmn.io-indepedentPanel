            ...
            new DropdownProperties(
                {
                    ...
                    key: 'eofType',
                    label: 'eofType',
                    options: [null,'ranUpToCompletion', 'transferToHuman', 'changeSubject'],
                    order: 1,
                    tab: 'EndOfFlow',
                    value: propertiesPanel.businessObject.$attrs.eofType,
                },
            ),
            new DropdownProperties(
                {
                    ...
                    key: 'eofAction',
                    label: 'eofAction',
                    options: [null,'backToIA', 'transferToHuman', 'gerentPJ'],
                    order: 2,
                    tab: 'EndOfFlow',
                    value: propertiesPanel.businessObject.$attrs.eofAction,
                },
            ),
            new TextboxProperties(
                {
                    ...
                    key: 'eofTags',
                    label: 'eofTags',
                    value: propertiesPanel.businessObject.$attrs.eofTags,
                    order: 3,
                    tab: 'EndOfFlow'
                },
            ),
